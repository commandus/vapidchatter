...
public:
	...
	static bool isPrivateKeyValid(
    const std::string &value
  );
  static bool isPublicKeyValid(
    const std::string &value
  );
  static bool isAuthSecretValid(
    const std::string &value
  );
...
public:
  ...
  static bool isTokenValid(const std::string &subscriptionToken);
};
...
public:
	...
	Subscription *findByPublicKey(const std::string &value) const;
  	Subscription *findByTokenNAuthSecret(const std::string &subscriptionToken, const std::string &authSecret) const;
    ...
    bool rmByPublicKey(const std::string &key);
...
public:
	...
	void reset();
	void load(std::istream &strm, bool isJson);
